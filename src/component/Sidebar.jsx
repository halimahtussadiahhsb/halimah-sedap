...
// Membedakaan mana kelas/menu yang aktif dan mana yang tidak aktif
    return (
        <div className="w-64 bg-gray-800 text-white h-screen p-5 flex flex-col">
            ...
            <nav className="flex-1">
                <ul className="space-y-2">
                    ...
                    <li className="flex items-center space-x-3 p-3 hover:bg-gray-700 rounded-md cursor-pointer">
                    <NavLink to="/products" end className={({ isActive }) => 
                                `${baseClass} ${isActive ? activeClass : "hover:bg-gray-700"}` 
                            }
                        >
                        <FaBox />
            ...
            <button className="flex items-center space-x-3 p-3 hover:bg-red-600 rounded-md cursor-pointer">
                <FaSignOutAlt/>
                <span>Logout</span>
            </button>
        </div>
