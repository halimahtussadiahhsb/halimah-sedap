  ...
  return (
    <div id="header-container" className="flex justify-between items-center p-4">
      ...
      <div id="search-bar" className="relative w-full max-w-lg">
        <input
          id="search-input"
          className="text-black border border-gray-200 p-2 pr-10 bg-white w-full rounded-md outline-none"
          type="text"
      ...
      <div id="icons-container" className="flex items-center space-x-4 ml-4">
        ...
        {/* Hello, Halimah */}
        <div id="profile-container" className="flex items-center border-l pl-4 border-gray-300">
          <span id="profile-text" className="mr-2">Hello, <b>Halimah</b></span>
